...
def test_use() :
    ...
    while check == True :
        ...
        if request == 'doc' :
            ...
            type_cart = input('what do you want which cart ?\nsingle cart - credit cart - timer cart\n')
            
            if type_cart == 'single cart' :
                globals()[f'cart{i}'] = single_cart()
                print(f'your cart name is : "cart{i}"')
                i += 1

            elif type_cart == 'credit cart' :
                try :
                    money = int(input('what you want how money ? '))
                    if money >= cart.rent :
                        globals()[f'cart{i}'] = credit_cart(money)
                        print(f'your cart name is : "cart{i}"')
                        i += 1
                    else :
                        print('Your money is less than the minimum "less than the rent" :(')
            ...
            elif type_cart == 'timer cart' :
                try :
                    money = int(input('what you want how money ? '))
                    if money >= cart.rent :
                        globals()[f'cart{i}'] = timer_cart(money)
                        print(f'your cart name is : "cart{i}"')
                        i += 1
                    else :
                        print('Your money is less than the minimum "less than the rent" :(')
                ...
                print('this cart is not avalible')
            print('\n'+'-'*38+'\n')
